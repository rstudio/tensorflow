...
This will provide you with a default installation of TensorFlow suitable for getting started with the tensorflow R package. See the [article on installation](installation.html) to learn about more advanced options.
